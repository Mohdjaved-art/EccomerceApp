...
class ShopRemoteDataSourceImpl @Inject constructor(
    private val apiService: ShopApiService  // here we use api service
    ...
    override suspend fun getBestProducts(category: String): Response<Shop> { //Best products testing.
        return apiService.getBestProducts(category)
    }
