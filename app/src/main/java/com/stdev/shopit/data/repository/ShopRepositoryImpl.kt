...
class ShopRepositoryImpl @Inject constructor(
    ...
    private val localDataSource: ShopLocalDataSource) : ShopRepository {
    ...
    override suspend fun getBestProducts(category: String): Resource<Shop> { //
        return responseToShopResult(remoteDataSource.getBestProducts(category))
    }
